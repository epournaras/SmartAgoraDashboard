    ...
    public class Client
    {
        ...
        public void CreateAsset(string projectId, Models.Asset[] Asset, string userName)
        {
            ...
            try
            {
                ...
                Console.WriteLine("WL: " + pathString);
                ...
                if (isLinuxDeployment)
                {
                    ...
                    startInfo.Arguments = "-c \"~/SmartAgoraBackend/Go_Workspace/bin/hive-command -host " + host + " -port " + port + " admin-create-assets " + projectId + " \"/" + pathString + "\"/" + fileName + ".json\"";
